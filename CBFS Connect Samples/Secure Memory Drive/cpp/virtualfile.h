...
//property
    ...
    PSECURITY_DESCRIPTOR get_SecurityDescriptor(VOID);
    INT get_SecurityDescriptor(INT SecurityInformation, PVOID Buffer, INT BufferLength, PINT SecurityDescriptorLength);
    INT set_SecurityDescriptor(INT SecurityInformation, PSECURITY_DESCRIPTOR SecurityDescriptor, INT SecurityDescriptorLength);
...
private:
    ...
    ULONG                mSecurityDescriptorLength;
};
