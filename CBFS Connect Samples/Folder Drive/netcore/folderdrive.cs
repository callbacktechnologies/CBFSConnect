...
namespace callback.Demos
{
    class folderdriveDemo
    {
        ...
        static void Usage()
        {
            Console.WriteLine("Usage: folderdrive-netcore.exe [-<switch 1> ... -<switch N>] <mapped folder> <mounting point>");
            Console.WriteLine("");
            Console.WriteLine("For example:  folderdrive-netcore.exe C:\\temp Z:");
